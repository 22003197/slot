...
<html>
<head>
    <title>SLOT TIME TABLE - SHRUTHI S (22003197)</title>
    <style>
        table {
...
<body>
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - SHRUTHI S (22003197)</strong></p>
    </div>
    <table>
        <tr>
...
```
## OUTPUT:
![image](https://github.com/22003197/slot/assets/124332243/b9a0311e-1bbf-4533-85ea-eeebd11d1d61)
